...
export default function DesktopAppWindow({
  ...
  return (
    <div
      className={cx(
        'pointer-events-auto absolute flex flex-col overflow-hidden border border-black/10 bg-white shadow-[0_24px_60px_rgba(0,0,0,0.35)]',
    ...
    >
      {/* 標題列（macOS 交通燈） */}
      <div
        className="flex h-9 shrink-0 cursor-grab touch-none select-none items-center gap-2 border-b border-black/10 bg-[#f4f4f5] px-3 active:cursor-grabbing"
      ...
      >
        ...
        <p className="flex-1 truncate text-center text-[12px] font-semibold text-[#374151]">
          {title}
        </p>
