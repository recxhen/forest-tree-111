...
export default function ThemeSkeleton() {
  return (
    <div className="flex min-h-screen flex-col lg:flex-row">
      {/* 側欄骨架 */}
      <aside className="flex w-full shrink-0 flex-col items-center gap-5 border-hl-border bg-hl-parchment-elevated/95 px-8 py-10 lg:w-[min(400px,36vw)] lg:max-w-[400px] lg:border-r">
        {/* 頭貼 */}
      ...
      <div className="flex min-w-0 flex-1 flex-col bg-transparent">
        {/* Tab 列骨架 */}
        <div className="flex justify-center gap-4 border-b border-hl-border px-4 py-3">
