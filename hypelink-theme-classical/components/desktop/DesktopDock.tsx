...
export default function DesktopDock({
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-4 z-30 hidden justify-center lg:flex">
      <div className="pointer-events-auto flex items-end gap-3 rounded-3xl border border-hl-border/50 bg-hl-parchment-elevated/25 px-4 pb-3 pt-2 shadow-[0_18px_40px_rgba(42,35,25,0.25)] backdrop-blur-2xl">
